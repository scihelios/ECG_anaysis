...
class RealTimePlotter(QMainWindow):
    def __init__(self):
        ...
        self.pen2 = pg.mkPen(color=(50, 25, 200), width=2, style=QtCore.Qt.SolidLine)


    def update_plot(self):
    # Assuming 'data' is a global variable containing the points from iterative_forecast
        global data
        global raw_signal
...
def iterative_forecast(initial_data, model, steps):
    ...
    with torch.no_grad():
        for _ in range(1,steps):
            ...
            data.extend(combined_gaussian(x_data,*np.array(prediction[0].tolist()[0:12])))
...
data = predicted_points = iterative_forecast(initial_points, model, steps=7)
...
global raw_signal
raw_signal= load_signals('C:/Users/ahmed mansour/Desktop/scolarite X/2A/Psc/ECG_anaysis/excess_code/s0543_re.dat')[600:len(data)+600]
